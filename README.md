...
**Guida al Campionato** (`public/season.js`, card dedicata in home): dopo l'asta, ogni giornata. Tre ingressi: Prova la Demo (lega casuale di 8 fantasquadre 3-8-8-6 generata dal database con draft a serpentina, nomi dimostrativi, squadra assegnata e cambiabile, “Genera un'altra lega Demo”, badge Modalità Demo + “Usa la mia lega”), Importa la tua lega (modello Excel Fantasquadra · Partecipante · Giocatore con esempi e istruzioni, generato e letto nel browser con SheetJS; validazione: colonne mancanti, righe incomplete, non riconosciuti con suggerimenti fuzzy “forse intendevi…”, omonimi con scelta del ruolo, duplicati tra fantasquadre con “tieni in…”; anteprima “Controlla la tua lega” con correzioni inline; lega salvata in localStorage con “Aggiorna lega” e modifica manuale dei singoli giocatori), Collega la tua lega (prossimamente). Flusso: la tua squadra → avversario della giornata → tre modalità sullo stesso motore (Consigliami la formazione / Controlla la mia formazione / Analizza la sfida) e approccio Prudente / Equilibrata / Aggressiva. Motore: score atteso per giocatore = base Fantalgoritmo (fantamedia, indice) × titolarità × difficoltà partita e casa/trasferta + potenziale bonus (gol, assist, rigori, piazzati) pesato per approccio; ottimizzatore di modulo tra 3-4-3, 4-3-3, 4-4-2, 3-5-2, 4-5-1, 5-3-2, 5-4-1; panchina ordinata. Output: campo con titolari (tap su titolare + panchinaro per cambiare, analisi aggiornata subito), adeguatezza 0–100 (vs avversario nelle modalità 2 e 3), rischio, affidabilità dell'analisi, verdetto, “Cosa migliorerei” (da cambiare / da valutare / lascerei così, o “va già bene”), dubbio principale, Confronta (tabella + consigliato + confidenza), Simula cambio (adeguatezza, bonus, rischio, applica/annulla), probabile formazione avversaria con affidabilità (modalità 2) o formazione avversaria inseribile (modalità 3), confronto per reparto a pallini con “dove puoi fare la differenza / dove sei più esposto”, analisi completa espandibile. **Dati di giornata (avversario reale, casa/trasferta, indisponibilità, ballottaggi) sono MOCK deterministici in `dayData()`, marcati nel codice per il collegamento a fonti live.** Struttura pensata per calendario, storico, classifica, mercato, notifiche.
